...
function GenerateSignature(method ,secretAcessKey , access_key ,times){
    var signatureBase="";
    var secretAcessKey = urlencode(secretAcessKey);
    var requestParameters = new Array();
    requestParameters['access_key'] = access_key;
    requestParameters['timestamp'] = times;
    requestParameters['method'] = method;

    signatureBase = 'access_key='+access_key+'&timestamp='+times+'&method='+method;
    var hash = hmacsha1(secretAcessKey,signatureBase);
	  return base64.encode(hash);	
    //console.log("sign at hmacsha1 : " + sign);
}
